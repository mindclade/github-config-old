...
# Mindclade security policy · `github-config`
...
| Repository scope | Enterprise GitHub governance, access, applications, and rulesets |

**Do not open a public issue for a vulnerability.**

| Channel | For |
|---|---|
| [Private security advisory](https://github.com/mindclade/github-config/security/advisories/new) | Anything in this repository. Preferred |
...
## Specific to `github-config`

This repository configures the organization itself — rulesets, team access, App scopes. A vulnerability here is a vulnerability in every other repository's protections, so treat anything that weakens a control as security-relevant even if it looks like a config tidy-up.
