...
## GitHub configuration-specific guidance

- [GitHub configuration architecture](architecture.md) defines the current control plane.
- [Repository production blueprint](../BLUEPRINT.md) is the compact authority contract.
- [Documentation home](README.md) routes governance changes and incidents.

When repository behavior and the enterprise target differ, treat code, tests, the catalog,
`contracts/repository.yaml`, and repository-specific documentation as current evidence; the
enterprise blueprint remains the approved target architecture.
